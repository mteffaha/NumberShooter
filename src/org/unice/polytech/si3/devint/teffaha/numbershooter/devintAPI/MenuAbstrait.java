...
import org.unice.polytech.si3.devint.teffaha.numbershooter.menu.MenuJeu;
	...
	*/
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_DOWN) {
            ...
            if(optionCourante==0){
                ((MenuJeu)this).quitter.stop();
                ((MenuJeu)this).jouer.playSound();
            }
            if(optionCourante==1){
                ((MenuJeu)this).quitter.playSound();
                ((MenuJeu)this).jouer.stop();
            }
		}
